        ...
        <div class="copyright-area-one">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="wrapepr">
                            <p> © <?php echo date("Y"); ?> GPS CHEMOIL LLC FZC TERMINAL-2.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- timepickers -->
    <script src="../../../../cdn.jsdelivr.net/npm/timepicker%401.11.12/jquery.timepicker.js"></script>
    <!-- sal animation -->
...
<!-- Mirrored from reactheme.com/products/html/elevate/onepage-one.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 07 May 2023 03:57:55 GMT -->
</html>